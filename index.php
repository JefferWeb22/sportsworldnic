...
<head>
    ...
    <title>SportsWorldNic</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/sportworldnic.ico" />
    <!-- Bootstrap icons-->
...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">SportsWorldNic</a>
    ...
    <header class="bg-success py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">SportsWorldNic</h1>
                <p class="lead fw-normal text-white50 mb-0">Lo mejor para tu familia en artículos deportivos</p>
            </div>
        </div>
    </header>
    <section class="py-5">
    ...
    <footer class="py-5 bg-success">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Todos los derechos reservados Jeffer Javier García Castillo 2023</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
